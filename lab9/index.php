...
<head>
    ...
    <title>Лабораторная работа №9(8)</title>
            ...
            for ($i = 0; $i < $numValues; $i++) {
                ...
                if ($layoutType == 'A' || $layoutType == 'B' || $layoutType == 'C' || $layoutType == 'D') {
                    if ($argument == 16) {
                        ...
                        $value = ($argument <= 10) ? (7 * $startArgument + 18) : (($argument > 10 && $argument < 20) ? (($argument - 17) /(8-$argument*0.5)) : (($argument + 4 ) * ($argument - 7)));
                    }
                    $values[] = $value;
